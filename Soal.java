...
public class Soal {
    ...
    public static void main(String[] args) {
        ...
        LinkedList <String> namaMahasiswa = new LinkedList<String>();
        LinkedList <String> nimMahasiswa = new LinkedList<String>();
        LinkedList <String> alamatMahasiswa = new LinkedList<String>();

        while(isLanjutkan){
            System.out.println("Menu Pilihan :");
            System.out.println("1. apakah LinkedList kosong?");
            ...
            switch(pilihan){
                ...
                case "7" :
                    System.out.println("Ambil elemen paling atas:  ");
                    System.out.println("===========");
                    System.out.println("");
                    System.out.println("Nama: "+namaMahasiswa.pop());
                    System.out.println("NIM: "+nimMahasiswa.pop());
                    System.out.println("alamat: "+alamatMahasiswa.pop());

                    break;
                
                case "8" :
                    System.out.println("Elemen paling atas sekarang: ");
                    System.out.println("");
                    System.out.println("Nama: "+namaMahasiswa.peek());
                    System.out.println("NIM: "+nimMahasiswa.peek());
                    System.out.println("alamat: "+alamatMahasiswa.peek());
                    break;
